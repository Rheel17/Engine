...
const GL::Framebuffer& Bloom::Render(const GL::Framebuffer& input) const {
	...
	GL::Program& combineShader = _CombineShader();
...
GL::Program& Bloom::_CombineShader() {
	if (!_combine_shader) {
