...
public:
	 ...
	 * single line.
	 */
	void DrawText(std::string_view text, int x, int y, const Font& font, unsigned size, const Color& color);
	 ...
	 */
	void DrawParagraph(std::string_view text, int x, int y, unsigned width, const Font& font, unsigned size, const Color& color, TextAlign align);
